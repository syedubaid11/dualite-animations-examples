...
const Loader = () => {
  ...
  return (
    <div className="parent-div-loader">
      <div className="loader-1-59156 pos-abs" id="id-11540">
        <div className="backcover-1-39360 pos-abs" id="id-11541">
          <div
            className="nodeBg-11541 pos-abs image-div bg-no-repeat fill-parent bg-cover"
            id="id-bg-11541"
          ></div>
        </div>
        <div className="loader-1-412644-container pos-abs" id="id-4280">
          <div className="property-1defau-1-2400 pos-abs" id="id-032">
